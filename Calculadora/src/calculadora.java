...
public class calculadora extends javax.swing.JFrame {
    ...
    // Borrar el contenido del label si hay un signo
    private void verificarSigno() {
       if (jLabel1.getText().contains("+") || jLabel1.getText().contains("-") ||
            jLabel1.getText().contains("*") || jLabel1.getText().contains("/")) {
            jLabel1.setText("");  // Borrar el contenido del label si hay un signo
        }
    }
}
